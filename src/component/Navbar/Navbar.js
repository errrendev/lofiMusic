      ...
      <nav>
        <div className='navbar'>
          ...
          <div className='social-links'>
            <a href='https://github.com/errrendev' target='_blank' rel='noreferrer'><i className='bx bxl-github' style={{ color: textColor}}></i></a>
            <a href='https://www.instagram.com/errren.dev' target='_blank' rel='noreferrer' style={{ color: textColor}}><i className='bx bxl-instagram'></i></a>
            <a href='https://www.linkedin.com/in/eren-yeager-570b3b30a/' target='_blank' rel='noreferrer' style={{ color: textColor}}><i className='bx bxl-linkedin-square'></i></a>
          </div>
        </div>
      </nav>
    </header>
